...
def _add_network_size_args(parser):
    ...
    # group.add_argument('--num-layers', type=int, default=31,
    #                    help='Number of transformer layers.')
    ...
    # group.add_argument('--hidden-size', type=int, default=2560,help = 'Tansformer hidden size.')
    group.add_argument('--num-attention-heads', type=int, default=None,
                       help='Number of transformer attention heads.')
    # group.add_argument('--num-attention-heads', type=int, default=32,
    #                    help='Number of transformer attention heads.')
...
def _add_training_args(parser):
    ...
    group.add_argument('--train-iters', type=int, default=4716,
...
def _add_checkpointing_args(parser):
    ...
    # group.add_argument('--load', type=str, default='/home/ferry/Pangu-alpha_2.6B_mgt/',
    #                    help='Directory containing a model checkpoint.')
...
def _add_data_args(parser):
    ...
    # group.add_argument('--vocab-file', type=str, default='/home/ferry/pangu-alpha-gpu/panguAlpha_pytorch/megatron/tokenizer/bpe_4w_pcl/vocab',
    #                    help='Path to the vocab file.')
    ...
    group.add_argument('--num-workers', type=int, default=20,
