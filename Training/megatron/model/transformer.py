...
class ParallelTransformer(MegatronModule):
    ...
    def forward(self, hidden_states, query_hidden_state, attention_mask, layer_past=None,
        ...
        # knowledge_matrix = knowledge_matrix.to(hidden_states.device)
        # knowledge_matrix = knowledge_matrix.cuda()
        # print('in ParallelTransformer, the knowledge_matrix shape =', knowledge_matrix.shape)
        # knowledge_matrix = knowledge_matrix.transpose(0, 1).contiguous()
        ...
        # motif
        # print('hidden_states.shape =', hidden_states.shape)
        # hidden_states += knowledge_matrix
